...
def get_data(filters):
	...
	query = query.groupby(mr.name, mr_item.item_code, mr.transaction_date, mr_item.schedule_date, mr_item.uom, mr_item.stock_uom, mr_item.item_name, mr_item.description, mr.company).orderby(mr.transaction_date, mr.schedule_date)
