...
def get_data(filters):
	...
	query = (
		...
		.groupby(po_item.name, po.transaction_date, po_item.schedule_date, po_item.project, po.name, po.status, po.supplier, po_item.item_code, po_item.qty, po_item.received_qty, po_item.base_amount, po_item.billed_amt, po.conversion_rate, po.set_warehouse, po.company)
